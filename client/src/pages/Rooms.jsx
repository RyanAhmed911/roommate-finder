                        ...
                        <div key={room._id} className="bg-white rounded-2xl overflow-hidden shadow-lg border border-slate-100 hover:shadow-xl transition-shadow flex flex-col h-full">
                            <div className="bg-indigo-600 p-4 flex justify-between items-center text-white">
                                ...
                                <div class="flex items-center gap-2">
                                    <button onclick="toggleFavorite(this)" class="p-1 hover:bg-white/20 rounded transition-colors" title="Remove from favorites">
                                        <svg class="w-5 h-5 star-filled" viewBox="0 0 24 24">
