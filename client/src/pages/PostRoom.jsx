...
const PostRoom = () => {
    ...
    const onSubmitHandler = (e) => {
        ...
        alert('Room posted successfully! Check console for data.')
    }
            ...
            <div className="bg-slate-900 p-8 rounded-2xl shadow-2xl w-full max-w-2xl text-white">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <button 
                        ...
                        className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 py-3 rounded-full font-bold mt-2 hover:scale-105 transition-all cursor-pointer"
                    >
                        Post & Find Roommates
                    </button>
                </div>
